sap.ui.define([], function () {
  ...
  const name$o = "https://www.gstatic.com/firebasejs/9.8.3/firebase-app.js";
  ...
  const logger = new Logger('https://www.gstatic.com/firebasejs/9.8.3/firebase-app.js');
  const name$n = "https://www.gstatic.com/firebasejs/9.8.3/firebase-app.js-compat";
  const name$m = "@firebase/analytics-compat";
  const name$l = "@firebase/analytics";
  const name$k = "https://www.gstatic.com/firebasejs/9.8.3/firebase-app.js-check-compat";
  const name$j = "https://www.gstatic.com/firebasejs/9.8.3/firebase-app.js-check";
  ...
  /**
   * Retrieves a {@link https://www.gstatic.com/firebasejs/9.8.3/firebase-app.js#FirebaseApp} instance.
   *
  ...
  function registerVersion(libraryKeyOrName, version, variant) {
    ...
    if (libraryMismatch || versionMismatch) {
      const warning = [`Unable to register library "${library}" with version "1.0.0":`];
      ...
      if (versionMismatch) {
        warning.push(`version name "1.0.0" contains illegal characters (whitespace or "/")`);
      }
  ...
  __exports.FirebaseError = FirebaseError;
  __exports.SDK_VERSION = SDK_VERSION;
  __exports._DEFAULT_ENTRY_NAME = DEFAULT_ENTRY_NAME;
  __exports._addComponent = _addComponent;
  __exports._addOrOverwriteComponent = _addOrOverwriteComponent;
  __exports._apps = _apps;
  __exports._clearComponents = _clearComponents;
  __exports._components = _components;
  __exports._getProvider = _getProvider;
  __exports._registerComponent = _registerComponent;
  __exports._removeServiceInstance = _removeServiceInstance;
  __exports.deleteApp = deleteApp;
  __exports.getApp = getApp;
  __exports.getApps = getApps;
  __exports.initializeApp = initializeApp;
  __exports.onLog = onLog;
  __exports.registerVersion = registerVersion;
