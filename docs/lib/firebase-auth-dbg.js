sap.ui.define([], function () {
  ...
  ***************************************************************************** */
  ...
  async function verifyPasswordResetCode(auth, code) {
    const {
      data
    } = await checkActionCode(getModularInstance(auth), code); // Email should always be present since a code was sent to it
  ...
  __exports.ActionCodeOperation = ActionCodeOperation;
  __exports.ActionCodeURL = ActionCodeURL;
  __exports.AuthCredential = AuthCredential;
  __exports.AuthErrorCodes = AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY;
  __exports.EmailAuthCredential = EmailAuthCredential;
  __exports.EmailAuthProvider = EmailAuthProvider;
  __exports.FacebookAuthProvider = FacebookAuthProvider;
  __exports.FactorId = FactorId;
  __exports.GithubAuthProvider = GithubAuthProvider;
  __exports.GoogleAuthProvider = GoogleAuthProvider;
  __exports.OAuthCredential = OAuthCredential;
  __exports.OAuthProvider = OAuthProvider;
  __exports.OperationType = OperationType;
  __exports.PhoneAuthCredential = PhoneAuthCredential;
  __exports.PhoneAuthProvider = PhoneAuthProvider;
  __exports.PhoneMultiFactorGenerator = PhoneMultiFactorGenerator;
  __exports.ProviderId = ProviderId;
  __exports.RecaptchaVerifier = RecaptchaVerifier;
  __exports.SAMLAuthProvider = SAMLAuthProvider;
  __exports.SignInMethod = SignInMethod;
  __exports.TwitterAuthProvider = TwitterAuthProvider;
  __exports.applyActionCode = applyActionCode;
  __exports.beforeAuthStateChanged = beforeAuthStateChanged;
  __exports.browserLocalPersistence = browserLocalPersistence;
  __exports.browserPopupRedirectResolver = browserPopupRedirectResolver;
  __exports.browserSessionPersistence = browserSessionPersistence;
  __exports.checkActionCode = checkActionCode;
  __exports.confirmPasswordReset = confirmPasswordReset;
  __exports.connectAuthEmulator = connectAuthEmulator;
  __exports.createUserWithEmailAndPassword = createUserWithEmailAndPassword;
  __exports.debugErrorMap = debugErrorMap;
  __exports.deleteUser = deleteUser;
  __exports.fetchSignInMethodsForEmail = fetchSignInMethodsForEmail;
  __exports.getAdditionalUserInfo = getAdditionalUserInfo;
  __exports.getAuth = getAuth;
  __exports.getIdToken = getIdToken;
  __exports.getIdTokenResult = getIdTokenResult;
  __exports.getMultiFactorResolver = getMultiFactorResolver;
  __exports.getRedirectResult = getRedirectResult;
  __exports.inMemoryPersistence = inMemoryPersistence;
  __exports.indexedDBLocalPersistence = indexedDBLocalPersistence;
  __exports.initializeAuth = initializeAuth;
  __exports.isSignInWithEmailLink = isSignInWithEmailLink;
  __exports.linkWithCredential = linkWithCredential;
  __exports.linkWithPhoneNumber = linkWithPhoneNumber;
  __exports.linkWithPopup = linkWithPopup;
  __exports.linkWithRedirect = linkWithRedirect;
  __exports.multiFactor = multiFactor;
  __exports.onAuthStateChanged = onAuthStateChanged;
  __exports.onIdTokenChanged = onIdTokenChanged;
  __exports.parseActionCodeURL = parseActionCodeURL;
  __exports.prodErrorMap = prodErrorMap;
  __exports.reauthenticateWithCredential = reauthenticateWithCredential;
  __exports.reauthenticateWithPhoneNumber = reauthenticateWithPhoneNumber;
  __exports.reauthenticateWithPopup = reauthenticateWithPopup;
  __exports.reauthenticateWithRedirect = reauthenticateWithRedirect;
  __exports.reload = reload;
  __exports.sendEmailVerification = sendEmailVerification;
  __exports.sendPasswordResetEmail = sendPasswordResetEmail;
  __exports.sendSignInLinkToEmail = sendSignInLinkToEmail;
  __exports.setPersistence = setPersistence;
  __exports.signInAnonymously = signInAnonymously;
  __exports.signInWithCredential = signInWithCredential;
  __exports.signInWithCustomToken = signInWithCustomToken;
  __exports.signInWithEmailAndPassword = signInWithEmailAndPassword;
  __exports.signInWithEmailLink = signInWithEmailLink;
  __exports.signInWithPhoneNumber = signInWithPhoneNumber;
  __exports.signInWithPopup = signInWithPopup;
  __exports.signInWithRedirect = signInWithRedirect;
  __exports.signOut = signOut;
  __exports.unlink = unlink;
  __exports.updateCurrentUser = updateCurrentUser;
  __exports.updateEmail = updateEmail;
  __exports.updatePassword = updatePassword;
  __exports.updatePhoneNumber = updatePhoneNumber;
  __exports.updateProfile = updateProfile;
  __exports.useDeviceLanguage = useDeviceLanguage;
  __exports.verifyBeforeUpdateEmail = verifyBeforeUpdateEmail;
  __exports.verifyPasswordResetCode = verifyPasswordResetCode;
  return __exports;
});
